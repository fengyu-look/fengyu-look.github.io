(() => {
  const skillCards = [
    {
      ...
      image: "https://wwobcjkakedxyruxulfj.supabase.co/storage/v1/object/public/site-media/assets/custom/work-card-skill-web.mp4",
      includes: ["skill-name"],
    ...
    },
    {
      ...
      image: "https://wwobcjkakedxyruxulfj.supabase.co/storage/v1/object/public/site-media/assets/custom/work-card-prompt-web.mp4",
  ...
  function mapContentItem(item) {
    ...
    return {
      ...
      image: item.cover_url || "https://wwobcjkakedxyruxulfj.supabase.co/storage/v1/object/public/site-media/assets/custom/work-card-skill-web.mp4",
